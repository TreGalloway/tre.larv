            ...
            <div class=" py-24 sm:py-32">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:mx-0">
                        <p class="text-base/7 font-semibold text-emerald-600">Hey I'm</p>
                        <h2 class="mt-2 text-5xl font-semibold tracking-tight text-gray-900 sm:text-7xl">Tre
                            Galloway</h2>
                        <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">I solve problems
                            with code.</p>
                    </div>
