    ...
    <div class="">
        <div class="container mx-auto px-4 py-10">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="h-full">
              <div class="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white shadow h-full">
                <div class="px-4 py-5 sm:p-6 flex-grow">
                  ...
                  <h1 class="text-xl font-semibold mb-4">Sup I'm Tre 👋🏾</h1>
                  <p class="text-lg">Turning problems into solutions with code. While reading a little too much fantasy.</p>
                  <div class="mt-6 flex">
                      <x-fab-youtube class="w-8 h-8 text-gray-600 hover:text-emerald-600 mx-2" />
                      <x-fab-bluesky class="w-8 h-8 text-gray-600 hover:text-emerald-600 mx-2" />
                      <x-fab-github class="w-8 h-8 text-gray-600 hover:text-emerald-600 mx-2"/>

                  </div>
                </div>
                <div class="px-4 py-4 sm:px-6">
                  <!-- Left card footer -->
                  <p class="max-w-2xl text-balance text-xl font-semibold tracking-tight text-gray-900 sm:text-xl">Want product news and updates? Sign up for our newsletter.</p>
            ...
            <!-- Right Column - Three Cards Stack -->
            <div class="space-y-6">
              <!-- First Card -->
              ...
              <div class="overflow-hidden rounded-lg bg-white shadow">
                <div class="px-4 py-5 sm:p-6">
                  ...
                  <h2 class="text-xl font-semibold mb-4">Right Column Card 2</h2>
              ...
              <div class="overflow-hidden rounded-lg bg-white shadow">
                <div class="px-4 py-5 sm:p-6">
                  ...
                  <h2 class="text-xl font-semibold mb-4">Right Column Card 3</h2>
